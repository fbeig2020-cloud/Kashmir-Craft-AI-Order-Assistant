# AI-Powered E-Commerce Order Operations Assistant — Traceability
...
| REQ-003 | Functional | must | STORY-013 |
| REQ-004 | Functional | must | STORY-014 |
| REQ-005 | Functional | must | STORY-003 |
| REQ-006 | Functional | must | STORY-004 |
| REQ-007 | Functional | must | STORY-005 |
| REQ-008 | Functional | must | STORY-006 |
| REQ-009 | Functional | must | STORY-007 |
| REQ-010 | Functional | must | STORY-008 |
| REQ-011 | Functional | must | STORY-009 |
| REQ-012 | Functional | must | STORY-012 |
| REQ-013 | Non-functional | must | STORY-015 |
| REQ-014 | Non-functional | must | STORY-011 |
| REQ-015 | Safety | must | STORY-001, STORY-002 |
| REQ-016 | Constraint | must | _(constraint — no story)_ |
